  ...
  <section class="container">
    <div class="mainVisual">
      <div class="swiper-container">
        <div class="swiper-wrapper">
          <div class="swiper-slide swiper-slide-active">
            <div class="inner">
              <div class="slogan">
                ...
                <span>Cloud 도입 컨설팅에서 설계, 구축, 운영까지</span>
                <a href="/m1/sub1.asp">View more</a>
              </div>
              <div class="visualImg visualImg02">
                <img src="http://injeinc.co.kr/images/main/slide01_test2.png" alt="구름">
                <canvas width=1200 height=750 class="canvas_bg"></canvas>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="inner">
              <div class="slogan">
                <p class="slogan_p">CONE <span>(Cloud One Stop Service)</span></p>
                <p>
                  CI/CD & Pipeline
                </p>
                <span>애플리케이션 개발 단계를 자동화하여 소스 통합 및 <br> 테스트 단계에서 개발의 민첩성을 제공</span>
      ...
      <div class="inner">
        ...
        <div class="swiper-btn">
          <span class="swiper-pause active"></span>
    ...
    <div class="section section01 animate on active">
      <div class="inner">
        <p class="secTitle animate fadeUp">
          Service
          <span>20여 년간 축적해온 경험과 기술력을 바탕으로 차별화된 IT 서비스를 제공합니다. </span>
        </p>
        <ul class="sec01List">
          <li>
            <div>
              <strong>Cloud 설계ㆍ구축</strong>
              <p>
                Hw/Sw 아키텍처 설계, <span></span>
                Cloud 인프라 설계, <span></span>
                IaaS & PaaS 설계 구축, <span></span>
                Cloud Management<span></span>
                Potal 설계 구축
              </p>
              <span class="sec01Icon"></span>
            </div>
          </li>
          <li>
            <div>
              <strong>솔루션 / 커스트마이징</strong>
              <p>
                CMP, PaaS, IaaS, DevOps,<span></span>
                웹IDE 등 자체 개발 <span></span>
                솔루션 납품 및<span></span> 커스트 마이징을 통한<span></span>클라우드 서비스 구축
              </p>
              <span class="sec01Icon"></span>
            </div>
          </li>
          <li>
            <div>
              <strong>컨설팅/매니지드 </strong>
              <p>
                클라우드 전환 컨설팅에서 구축, <span></span>
                마이그레이션, 모니터링, 기술지원까지 <span></span>
                IT전반에 걸친 전문 운영 서비스
              </p>
              <span class="sec01Icon"></span>
            </div>
          ...
          <li>
            <div>
              <strong> SI/SM</strong>
              <p>
                공공 민간 시스템 통합 및 구축,<span></span>
                클라우드 전환 구축, 온프레미스<span></span>
                시스템 운영 서비스
              </p>
              <span class="sec01Icon"></span>
            </div>
        ...
        <div class="sec01Imgwrap4 sec01Img"></div>
        <div class="sec01Imgwrap5 sec01Img"></div>
    ...
    <div class="section section02 animate on active">
      <div class="inner">
        <p class="secTitle animate fadeUp">
          Solutions
          <span>독자 기술로 개발하고 다양한 구축 레퍼런스를 통해 검증받은 Cloud 솔루션 </span>
        </p>
        <ul class="sec02List">
          <li class="type1">
            <a href="/m2/sub1.asp">
              <p class="txt">
                <strong class="title">CONE-Plus</strong>
                IaaS & PaaS 통합 관리, 고객 니즈 및 <span></span>
                환경에 맞는 유연한 CMP 구축 가능
              </p>
              <span class="imgBox">
          ...
          <li class="type2">
            <a href="/m2/sub4.asp">
              <p class="txt">
                <strong class="title">CONE-DevOps</strong>
                오픈 소스 개발지원도구 활용, <span></span>
                Pipeline 기반 개발공정 자동화
              </p>
              <span class="imgBox">
                <span class="Icon">View more</span>
          ...
          <li class="type3">
            <a href="/m2/sub5.asp">
              <p class="txt">
                <strong class="title">CONE-IDE</strong>
                PaaS 플랫폼 기반 Web IDE 제공,<span></span>
                템플릿 기반 쉽고 빠른 개발환경 구성 가능
              </p>
              <span class="imgBox">
                <span class="Icon">View more</span>
    ...
    <div class="section section03 active" >
      <div class="inner">
        ...
        <div class=" animate fadeUp">
          <ul class="tabBar">
              <li class="active"><a href="/index.asp#none">전체</a></li>
              <li ><a href="/index.asp?gubun=02#none">동향</a></li>
    ...
    <div class="section04">
      <div class="inner">
        <p class="secTitle animate fadeUp">
          서비스 상담 및 문의
          <span>서비스 상담을 원하시거나 문의사항이 있으시면 아래 채널로 연락주세요</span>
        </p>
        <div class="callBanner">
          ...
          <div class="right">
            <p>
              <strong>070-4609-6333</strong>
              운영 시간: 월~금 10:00-19:00
            </p>
          </div>
        </div>
        <div class="inqBanner animate">
          <div class="left animate fadeLeft">
            <p>
              <strong>온라인 1:1 문의</strong>
              인재INC 클라우드만의 상세한 컨설팅을<br>
              받아 보실 수 있습니다.
            </p>
            <a href="/m3/sub3.asp" class="btn" >문의하기</a>
          </div>
          <div class="right animate fadeRight">
            <p>
              <strong>카카오톡 문의</strong>
              업무 시간 외 서비스 문의, 견적 등 사업 관련 문의를<br>
              받아 보실 수 있습니다.
            </p>
            <span class="btn">카카오톡 ID: inje_support</span>
          </div>
        </div>
        <ul class="inqBanner2">
          <li class="animate delay">
            <strong>클라우드 구축, 솔루션 문의</strong>
            <span>유경배 이사</span>
            <ul class="inqBanner2_list">
              <li>HP : 010-4367-0503</li>
              <li>E-mail : kbyu54@injeinc.co.kr</li>
            </ul>
          </li>
          <li class="animate delay2">
            <strong>클라우드 매니지드 부문 문의</strong>
            <span>박형서 수석</span>
            <ul class="inqBanner2_list">
              <li>HP : 010-4033-8455</li>
              <li>E-mail : hspark@injeinc.co.kr</li>
            </ul>
          </li>
          <li class="animate delay3">
            <strong>시스템 통합ㆍ구축 문의</strong>
            <span>김정만 상무</span>
            <ul class="inqBanner2_list">
              <li>HP : 010-3613-5250</li>
              <li>E-mail : jm.kim68@injeinc.co.kr</li>
            </ul>
          </li>
        </ul>
      </div>
...
.mainVisual .swiper-play{position:absolute; display:inline-block; width:24px; height:24px; opacity:0; z-index:0; cursor:pointer; background:url("http://injeinc.co.kr/images/main/start.png") center no-repeat;}
.mainVisual .swiper-pause{position:absolute; display:inline-block; width:24px; height:24px; opacity:0; z-index:0; cursor:pointer; background:url("http://injeinc.co.kr/images/main/pause.png") center no-repeat;}
...
.section01.active .sec01Imgwrap2{width:265px; height:287px; position:absolute; top:410px; left:440px;  transition:1s; opacity:1; filter:alpha(opacity=100);transform: rotate(-360deg); background:url("http://injeinc.co.kr/images/main/line.png") no-repeat;}
.section01.active .sec01Imgwrap3{width:48px; height:48px; position:absolute; top:415px; left:408px;  transition:1s; opacity:1; filter:alpha(opacity=100); animation:animation3 1.5s infinite  alternate-reverse; background:url("http://injeinc.co.kr/images/main/sec01Icon05.png") center no-repeat;}
.section01.active .sec01Imgwrap4{width:48px; height:48px; position:absolute; top:338px; left:575px;  transition:1s; opacity:1; filter:alpha(opacity=100);animation:animation3 1.2s infinite  alternate-reverse; background:url("http://injeinc.co.kr/images/main/sec01Icon06.png") center no-repeat; }
.section01.active .sec01Imgwrap5{width:48px; height:48px; position:absolute; top:686px; left:634px;  transition:1s; opacity:1; filter:alpha(opacity=100); animation:animation3 1.1s infinite  alternate-reverse; background:url("http://injeinc.co.kr/images/main/sec01Icon07.png") center no-repeat; }
...
.section01.active .sec01Imgwrap6{width:400px; height:460px; position:absolute; top:330px; left:374px;  transition:1s;animation:animation4 2s infinite  alternate-reverse; background:url("http://injeinc.co.kr/images/main/dot pattern.png") center no-repeat;}
...
.section01 .sec01List li span.sec01Icon{position:absolute; right:-60px; bottom:-70px; width:184px; height:194px; background:url("http://injeinc.co.kr/images/main/sec01Icon01.png") center no-repeat;}
...
.section01 .sec01List li:nth-child(2) span.sec01Icon{left:-60px; bottom:-70px; width:189px; height:194px; background:url("http://injeinc.co.kr/images/main/sec01Icon02.png") center no-repeat;}
...
.section01 .sec01List li:nth-child(3) span.sec01Icon{right:-130px; top:-57px; width:263px; height:183px; background:url("http://injeinc.co.kr/images/main/sec01Icon03.png") center no-repeat;}
...
.section01 .sec01List li:nth-child(4) span.sec01Icon{left:-75px; top:-45px;  width:203px; height:172px; background:url("http://injeinc.co.kr/images/main/sec01Icon04.png") center no-repeat;}
...
.section02 .sec02List li:nth-child(2) .imgBox span.Icon{width:145px; height:145px; background:url("http://injeinc.co.kr/images/main/sec02Icon02.png") center no-repeat;}
.section02 .sec02List li:nth-child(3) .imgBox span.Icon{width:145px; height:145px; background:url("http://injeinc.co.kr/images/main/sec02Icon03.png") center no-repeat;}
...
.section04 .inqBanner .left a{width:138px; height:55px; padding-right:10px; display:block; text-align:center;  margin-top:20px; border:1px solid #000; font-size:20px; border-radius:45px; line-height:55px; background:url("http://injeinc.co.kr/images/main/arrow.png") top 50% right 15% no-repeat;}
